const I18n = (() => {
  ...
  const TRANSLATIONS = {
    ru: {
      ...
      hintHiddenRow: 'Цифра {v} в этой строке больше некуда поставить',
      hintHiddenCol: 'Цифра {v} в этом столбце больше некуда поставить',
      hintHiddenBox: 'Цифра {v} в этом блоке 3×3 больше некуда поставить',
    ...
    en: {
      ...
      hintHiddenRow: '{v} has nowhere else to go in this row',
      hintHiddenCol: '{v} has nowhere else to go in this column',
      hintHiddenBox: '{v} has nowhere else to go in this 3×3 box',
